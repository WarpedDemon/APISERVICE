...
function CreateConnectionObject() {
	try {
		$dsn = "mysql:https://student.mydesign.central.wa.edu.au:8443/domains/databases/phpMyAdmin/index.php;dbname=DataBaseAppServer;charset=utf8;";
		$db = new PDO($dsn, 'WarpedPrince', 'Diablo12');
	}
